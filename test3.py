...
https://github.com/shaoncsecu/Text2RDF/blob/main/Scripts/Extract_triple_from_UDPipe.py
...
def get_triplets(file_path):
    ...
    # data = "Le patient prend un médicament. Le médecin prescrit un traitement."
    triplets_out = []
